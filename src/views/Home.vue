    ...
    <section>
      ...
      <div class="lunbo">
        ...
        <div class="bottom">
          ...
          >
            <van-swipe-item v-for="(itme, index) in hint" :key="index">{{
              itme.title
            }}</van-swipe-item>
          </van-swipe>
        </div>
        ...
        <div class="account-recommend-box">
          ...
          <div class="account-recommend-content">
            ...
            <div class="item-box">
              ...
              >
                <van-swipe-item
                  v-for="(itme, index) in compensate"
                  :key="index"
                >
      ...
      <div class="list-wrap">
        <div class="tabs-box">
          <div class="tabs-area">
            ...
            >
              <p
                :class="active1 == index ? 'jiajia' : ''"
                class="tabs-txt"
                @click="Switchingdata(item.content, index)"
              >
                {{ item.title }}
              </p>
            </div>
